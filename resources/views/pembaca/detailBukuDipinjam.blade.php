...
@section('title', 'Detail Buku Dipinjam')
    ...
    <div class="catalog-container">
        <div class="book-detail">
            ...
            <div class="book-info">
                ...
                <div class="buttons">
                    <a href="{{ session('origin') === 'dashboard' ? route('pembaca.dashboard') : (session('origin') === 'katalog' ? route('pembaca.pinjam') : route('pembaca.history')) }}" class="btn-back">Back</a>
                    
                    <a href="{{ route('buku.baca', $book->kode_buku) }}" class="btn-borrow">Baca</a>
                </div>
            </div>
        </div>
    </div>
