                                ...
                                <div class="modal-body">
                                    <form action="{{route('penulis.store')}}" method="POST">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="nama_penulis" id="nama_penulis">
                                        </div>
                    ...
                    <div class="modal fade" id="editModal{{$data->id}}" tabindex="-1" aria-labelledby="editModalLabel{{$data->id}}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('penulis.update', $data->id)}}" method="post" >@csrf
                                        @csrf
                                        <div class="form-group mb-6">
                                            <label for="nama">Nama Penulis<span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="nama_penulis" id="nama_penulis" value="{{$data->nama_penulis}}">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content text-center">
                                ...
                                <div class="modal-footer border-0 d-flex justify-content-center">
                                    ...
                                    <form action="{{route('penulis.delete', $data->id)}}" method="post" class="d-inline-block">@csrf
